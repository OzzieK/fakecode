# -*- coding: utf-8 -*-
# @Author: Jie Yang
# @Date:   2017-10-17 16:47:32,     Contact: jieynlp@gmail.com
...
import numpy as np
from models.charfeat.charbilstm import CharBiLSTM
from models.charfeat.charbigru import CharBiGRU
from models.charfeat.charcnn import CharCNN
...
class WordRep(nn.Module):
    ...
    def forward(self, word_inputs, pos_inputs, word_seq_lengths, char_inputs, char_seq_lengths, char_seq_recover):
        ...
        word_list = [word_embs]
        if self.pos_as_feature:
            word_list.append(self.pos_embedding(pos_inputs))
        if self.use_char:
        ...
        return word_represent # [batch_size, batch_max_sentence_length, word_emb_dim+char_hidden_dim(+pos_emb_dim)]
