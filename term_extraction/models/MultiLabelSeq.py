...
class MultiLabelSeq(nn.Module):
    ...
    def forward(self, word_inputs, pos_inputs, word_seq_lengths, char_inputs, char_seq_lengths, char_seq_recover, batch_label, mask, sent_text, evaluating=False):
        ...
        predicted_labels = predicted_sigmoid.gt(0.6)
...
if __name__ == '__main__':
    ...
    reps = span_seq(word_seq_tensor, pos_seq_tensor, word_seq_lengths, char_seq_tensor, char_seq_lengths, char_seq_recover, labels, mask)
    print(reps)